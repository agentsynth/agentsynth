...
Works like a careful operator — look at the rows first, make the change, read it
back, then answer from what it saw. Stays the documented oracle path:
...
# inspect -> act -> verify, one SQL statement per step.
_PLAN = {
    "refund-order": [
